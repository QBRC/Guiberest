...
insert into acl (id, username, role_id, access, class, pk) values (5, 'thomas', null, 'read',  'edu.swmed.qbrc.guiberest.shared.domain.guiberest.Customer', '21');
insert into acl (id, username, role_id, access, class, pk) values (6, 'thomas', null, 'read',  'edu.swmed.qbrc.guiberest.shared.domain.guiberest.Customer', '23');
insert into acl (id, username, role_id, access, class, pk) values (7, 'thomas', null, 'read', 'edu.swmed.qbrc.guiberest.shared.domain.guiberest.Sale', '32');
insert into acl (id, username, role_id, access, class, pk) values (8, 'thomas', null, 'read', 'edu.swmed.qbrc.guiberest.shared.domain.guiberest.Sale', '33');
insert into acl (id, username, role_id, access, class, pk) values (9, 'thomas', null, 'read', 'edu.swmed.qbrc.guiberest.shared.domain.guiberest.Sale', '34');
